  ...
  return (
    ...
    >
      <div className="space-y-5 text-left pt-1">
        {/* Hero Score Display */}
        <div className="p-5 rounded-2xl bg-surface-sunken border border-border/80 flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-[11px] text-muted-foreground mt-1 font-semibold">
              Top 12% execution consistency across all tracked habits
            </p>
          </div>
          ...
          <div className="space-y-2 text-xs font-semibold">
            ...
            <div className="p-3 rounded-xl bg-surface-elevated border border-border/70 space-y-1.5">
              <div className="flex justify-between items-center text-foreground">
                ...
                <span className="font-mono text-emerald-400 font-bold">{breakdown.execution}%</span>
              </div>
            ...
            <div className="p-3 rounded-xl bg-surface-elevated border border-border/70 space-y-1.5">
              <div className="flex justify-between items-center text-foreground">
                ...
                <span className="font-mono text-cyan-400 font-bold">{breakdown.reliability}%</span>
              </div>
            ...
            <div className="p-3 rounded-xl bg-surface-elevated border border-border/70 space-y-1.5">
              <div className="flex justify-between items-center text-foreground">
                ...
                <span className="font-mono text-emerald-400 font-bold">{breakdown.recovery}%</span>
              </div>
        ...
        <div className="p-3.5 rounded-xl bg-surface-sunken border border-border/60 text-xs text-muted-foreground space-y-1">
          ...
          <p className="text-[11px] font-mono text-slate-300">{breakdown.formula}</p>
        </div>
      </div>
    </Modal>
  );
