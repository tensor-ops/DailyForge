  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto text-left selection:bg-primary/20 select-none animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-[#101622] border border-[#1D293D] rounded-[14px] p-5 flex flex-col justify-between h-full md:col-span-2">
        ...
        <Card className="bg-[#101622] border border-[#1D293D] rounded-[14px] p-5 flex flex-col justify-between h-full">
          ...
          <div>
            <p className="text-3xl font-extrabold text-slate-100 tracking-tight">1.4 days</p>
        ...
        <Card className="bg-[#101622] border border-[#1D293D] rounded-[14px] p-5 flex flex-col justify-between h-full">
          ...
          <div>
            <p className="text-3xl font-extrabold text-[#10B981] tracking-tight">92%</p>
        ...
        <div className="h-[240px] text-xs">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={trendData} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
              ...
              />
              <Area type="monotone" dataKey="momentum" stroke="#2563EB" strokeWidth={2.2} fill="url(#momGrad)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </ChartCard>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <Card className="bg-[#101622] border border-[#1D293D] rounded-[14px] p-5 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4 text-xs font-semibold text-slate-300">
              ...
              <div className="p-3 bg-[#131B29] border border-border/5 rounded-xl text-left">
                ...
                <span className="text-slate-100 font-extrabold text-sm flex items-center gap-0.5 mt-0.5">
                  🔥 22 Days
                </span>
              </div>
              <div className="p-3 bg-[#131B29] border border-border/5 rounded-xl text-left">
                <span className="text-[10px] text-muted-foreground block font-bold">Recent Milestones</span>
                <span className="text-slate-300 font-medium block mt-1">10-day (Aug 8)</span>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-[#101622] border border-[#1D293D] rounded-[14px] p-5 space-y-4">
            ...
            <div className="space-y-3.5 text-xs font-semibold text-slate-300">
              <div className="flex justify-between items-center p-3 bg-[#131B29] border border-border/5 rounded-xl">
                <span className="flex items-center gap-1.5"><Clock className="h-4 w-4 text-success" /> Exercise</span>
                <span className="text-success font-extrabold">+18%</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-[#131B29] border border-border/5 rounded-xl">
                <span className="flex items-center gap-1.5"><Clock className="h-4 w-4 text-success" /> DSA Practice</span>
                <span className="text-success font-extrabold">+12%</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-[#131B29] border border-border/5 rounded-xl">
                <span className="flex items-center gap-1.5"><Clock className="h-4 w-4 text-warning" /> Reading</span>
